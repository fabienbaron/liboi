...
* For ATI GPUs or AMD CPUs: `sudo apt-get install fglrx` or [ATI drivers](http://support.amd.com/us/gpudownload/Pages/index.aspx), then install the [OpenCL SDK](http://developer.amd.com/tools/heterogeneous-computing/amd-accelerated-parallel-processing-app-sdk/downloads/)
